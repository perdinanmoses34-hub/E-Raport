...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200 px-3 sm:px-6 py-2.5 transition-all no-print">
      <div className="flex items-center justify-between gap-2 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="p-2 rounded-xl text-slate-600 hover:text-slate-900 hover:bg-slate-100 active:scale-95 transition"
